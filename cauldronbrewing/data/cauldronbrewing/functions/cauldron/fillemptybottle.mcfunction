...
execute if entity @e[type=armor_stand,distance=..0.5,name="cauldron",scores={potionid=19,potionmodifier=1}] run give @s minecraft:potion{CustomPotionEffects:[{Id:25,Duration:240}],CustomPotionColor:14810044,display:{Name:"{\"text\":\"§rPotion of Levitation\"}"}} 1
execute if entity @e[type=armor_stand,distance=..0.5,name="cauldron",scores={potionid=19,potionmodifier=2}] run give @s minecraft:potion{CustomPotionEffects:[{Id:25,Duration:440}],CustomPotionColor:14810044,display:{Name:"{\"text\":\"§rPotion of Levitation\"}"}} 1
execute if entity @e[type=armor_stand,distance=..0.5,name="cauldron",scores={potionid=19,potionmodifier=3}] run give @s minecraft:potion{CustomPotionEffects:[{Id:25,Amplifier:1,Duration:200}],CustomPotionColor:14810044,display:{Name:"{\"text\":\"§rPotion of Levitation\"}"}} 1
execute if entity @e[type=armor_stand,distance=..0.5,name="cauldron",scores={potionid=19,potionmodifier=4}] run give @s minecraft:splash_potion{CustomPotionEffects:[{Id:25,Duration:240}],CustomPotionColor:14810044,display:{Name:"{\"text\":\"§rPotion of Levitation\"}"}} 1
execute if entity @e[type=armor_stand,distance=..0.5,name="cauldron",scores={potionid=19,potionmodifier=5}] run give @s minecraft:splash_potion{CustomPotionEffects:[{Id:25,Duration:440}],CustomPotionColor:14810044,display:{Name:"{\"text\":\"§rPotion of Levitation\"}"}} 1
execute if entity @e[type=armor_stand,distance=..0.5,name="cauldron",scores={potionid=19,potionmodifier=6}] run give @s minecraft:splash_potion{CustomPotionEffects:[{Id:25,Amplifier:1,Duration:200}],CustomPotionColor:14810044,display:{Name:"{\"text\":\"§rPotion of Levitation\"}"}} 1
execute if entity @e[type=armor_stand,distance=..0.5,name="cauldron",scores={potionid=19,potionmodifier=7}] run give @s minecraft:lingering_potion{CustomPotionEffects:[{Id:25,Duration:240}],CustomPotionColor:14810044,display:{Name:"{\"text\":\"§rPotion of Levitation\"}"}} 1
execute if entity @e[type=armor_stand,distance=..0.5,name="cauldron",scores={potionid=19,potionmodifier=8}] run give @s minecraft:lingering_potion{CustomPotionEffects:[{Id:25,Duration:440}],CustomPotionColor:14810044,display:{Name:"{\"text\":\"§rPotion of Levitation\"}"}} 1
execute if entity @e[type=armor_stand,distance=..0.5,name="cauldron",scores={potionid=19,potionmodifier=9}] run give @s minecraft:lingering_potion{CustomPotionEffects:[{Id:25,Amplifier:1,Duration:200}],CustomPotionColor:14810044,display:{Name:"{\"text\":\"§rPotion of Levitation\"}"}} 1
